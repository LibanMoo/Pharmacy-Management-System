...
<div id="modalContainer" class="w-full h-screen fixed top-0 left-0 z-10 flex justify-center items-center bg-black bg-opacity-50">
    ...
    <!-- Main modal -->
            <div class="bg-white rounded-lg shadow relative dark:bg-gray-700 w-[50%]">
                ...
                <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="#">
                    ...
                    <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register Admin</button>
                </form>
            </div>
        </div>
